...
export function BrowseProperties({
  ...
  }, [searchQuery, cityFilter, bedroomFilter, properties]);
    ...
    <div className="bg-white min-h-screen">
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center gap-4 mb-8">
          <div className="bg-[#222B52] text-white px-4 py-2 rounded">
            BUY
          </div>
        ...
        <p className="text-[#7F858D] mb-8">
          ...
          available for purchase. Find your dream home today.
        </p>
        ...
        <div className="mb-6">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 border border-[#7F858D] rounded focus:outline-none focus:ring-2 focus:ring-[#222B52]"
